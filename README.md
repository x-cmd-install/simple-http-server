...
[![x-cmd/install — simple-http-server Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/simple-http-server.svg)](https://x-cmd.com/install/simple-http-server)
...
Total: **2,800** lines of code across **11** files in the top 5 languages.
...
- **Upstream**: <https://github.com/TheWaWaR/simple-http-server>
- **License**: MIT
...
- **Stars**: 3,458 · **Forks**: 217 · **Open issues**: 97 · **Contributors**: 26

## Totals (cumulative)

- **Releases**: 15 · **Merged PRs**: 34 · **Open PRs**: 6 · **Closed issues**: 59 · **Open issues**: 38 · **Commits**: 244
...
_Snapshot: `data/card/260924.yml` · 2026-09-24T04:58:14Z._
