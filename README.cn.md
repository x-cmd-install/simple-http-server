...
[![x-cmd/install — simple-http-server Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/simple-http-server.svg?lang=zh)](https://x-cmd.com/install/simple-http-server)

## 安装

```sh
x install simple-http-server
```

## 代码洞察

合计: **2,800** 行代码（覆盖前 5 种语言、共 **11** 个文件）。
...
- **上游仓库**: <https://github.com/TheWaWaR/simple-http-server>
- **许可证**: MIT
...
- **Star**: 3,457 · **Fork**: 218 · **开放 issue**: 97 · **贡献者**: 26

## 累计统计

- **发布数**: 15 · **已合并 PR**: 34 · **开放 PR**: 6 · **已关闭 issue**: 59 · **开放 issue**: 38 · **提交数**: 244
...
| last60d | 2026-07-25 | 0 | 0 | 1 | 0 | 0 | 2 |
| 90d | 2026-06-25 | 0 | 0 | 1 | 0 | 0 | 2 |
| last180d | 2026-03-27 | 0 | 0 | 1 | 0 | 1 | 2 |
| 360d | 2025-09-28 | 2 | 0 | 1 | 2 | 1 | 8 |
| last720d | 2024-10-03 | 5 | 4 | 3 | 8 | 6 | 24 |
...
simple-http-server 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `simple-http-server` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/simple-http-server.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:07:53Z._
